...
int main()
{
	...
	//Variaveis do segundo programa
	int B; float A, C;
	
	//Variaiveis dp terceiro programa
	int b; float a, H; double c;
	...
	{	
		...
		printf("\n2-Programa que le um numero de ponto flutuante(A) e um numero inteiro(B), e depois retorna a potencia de A elevado a B");
		printf("\n3-Programa que le um numero de ponto flutuante(A) e um numero inteiro(B), e depois retorna a raiz de A na base B");
		...
		switch(i)
		{
			//Programa que verifica se o número é Par ou Não
			case 1 :
			...
			//Programa que le um número de ponto flutuante(A) e um numero inteiro(B), e depois retorna a potencia de A elevado a B
			case 2 :
				...
				printf("\nO resultado em notacao cientifica e: %1.2E \n", C );
			break;
			
			//Programa que le um numero de ponto flutuante(A) e um numero inteiro(B), e depois retorna a raiz de A na base B
			case 3 :	
				printf("\nDigite um numero de ponto flutuante: ");
				scanf("%f", &a);
				...
				printf("\nO resultado em notacao cientifica e: %E \n", c );
			break;	
